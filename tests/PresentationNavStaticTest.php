...
class PresentationNavStaticTest extends TestCase
{
    public function testSourceAndDistHaveNoCollapseControls(): void
    {
        ...
        $this->assertStringContainsString('.App-titleControl .Dropdown-menu .FlatRateDiscussionBrandLink', $less);
        $this->assertStringContainsString('.App-titleControl .Dropdown-menu .FlatRateDiscussionBrandLink.depth-1', $less);
        ...
        $this->assertStringContainsString('.App-titleControl .FlatRateDiscussionBrandLink .icon', $less);
